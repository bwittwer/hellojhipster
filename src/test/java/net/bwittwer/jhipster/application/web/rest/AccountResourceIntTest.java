package net.bwittwer.jhipster.application.web.rest;

import net.bwittwer.jhipster.application.config.Constants;
import net.bwittwer.jhipster.application.HellojhipsterApp;
import net.bwittwer.jhipster.application.domain.Authority;
import net.bwittwer.jhipster.application.domain.User;
import net.bwittwer.jhipster.application.repository.AuthorityRepository;
import net.bwittwer.jhipster.application.repository.UserRepository;
import net.bwittwer.jhipster.application.security.AuthoritiesConstants;
import net.bwittwer.jhipster.application.service.MailService;
import net.bwittwer.jhipster.application.service.dto.UserDTO;
import net.bwittwer.jhipster.application.web.rest.errors.ExceptionTranslator;
import net.bwittwer.jhipster.application.web.rest.vm.KeyAndPasswordVM;
import net.bwittwer.jhipster.application.web.rest.vm.ManagedUserVM;
import net.bwittwer.jhipster.application.service.UserService;
