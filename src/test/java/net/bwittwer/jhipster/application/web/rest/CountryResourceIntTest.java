...
import net.bwittwer.jhipster.application.repository.CountryRepository;
import net.bwittwer.jhipster.application.service.CountryService;
import net.bwittwer.jhipster.application.service.dto.CountryDTO;
import net.bwittwer.jhipster.application.service.mapper.CountryMapper;
...
import static net.bwittwer.jhipster.application.web.rest.TestUtil.createFormattingConversionService;
...
public class CountryResourceIntTest {
    ...
    public void createCountry() throws Exception {
        ...
        assertThat(testCountry.getTest()).isEqualTo(DEFAULT_TEST);
    }
    ...
    public void updateCountry() throws Exception {
        ...
        assertThat(testCountry.getTest()).isEqualTo(UPDATED_TEST);
    }
